...
export default {
  ...
  computed: {
    prompt() {
      return `Сгенерируй 3 варианта, синонимы, альтернативные сочетания слов и уникальные комбинации, помогая создать запоминающееся доменное имя, используй ${this.value} как ключевое слово .`;
    },
  },
};
</script>
